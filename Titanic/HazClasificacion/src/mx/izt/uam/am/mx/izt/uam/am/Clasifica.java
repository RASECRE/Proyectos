...
public class Clasifica {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Lee modelo
        File modelo = new File("ModeloTitanic.model");
        ...
        // Prepara el escritor de archivos
        FileWriter csvWriter = new FileWriter("TitanicSub.csv");
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            double clase = clasificador.classifyInstance(datum);
             ...
             // Obtener PassengerId
             int passengerId = (int) datum.value(0);
    
             // Escribir en formato CSV
             csvWriter.append(passengerId + "," + (int) clase + "\n");
        }
